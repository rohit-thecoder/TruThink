...
const CtaButton = () => {
  ...
  return (
    <Link href="/contact">
      <button className="cursor-pointer relative group z-2 bg-[#ff7a00] hover:bg-[#e56700] text-white font-semibold uppercase px-8 py-3 rounded-lg  transition-all duration-300 flex items-center justify-center overflow-hidden">
