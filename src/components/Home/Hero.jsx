...
export default function Hero() {
  return (
    <div className="flex flex-col items-center justify-around h-auto bg-white  gap-10 py-10">
      <div className="flex flex-row justify-center items-center color-secondary-bg px-4 py-8 pl-4 h-10  rounded-full gap-4">
        <div className="flex flex-row justify-center items-center bg-white py-2 px-2 rounded-2xl gap-2">
          ...
          <h3 className="text-xs font-regular">COINEST</h3>
        </div>
        <h3 className="text-sm font-regular">Smarter Money Management</h3>
      </div>
      ...
      <button className='color-secondary-bg py-4 px-12 rounded-full font-bold'>Get Started</button>

      <div className='mx-[10%] box-border border-x-16 border-t-16 w-[80%] h-130 rounded-t-2xl bg-border'>
