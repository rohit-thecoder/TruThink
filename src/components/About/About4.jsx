  ...
  return (
    <section ref={containerRef} className="relative py-24 px-6 md:px-20">
        ...
        <div className="max-w-7xl mx-auto">
            ...
            {/* Left Column (Header) */}
            <div className="lg:col-span-5 lg:sticky lg:top-32 about4-header opacity-0">
            ...
            <div className="lg:col-span-7 space-y-12 right-column">
                ...
                <div className="about4-text opacity-0">
                ...
                <div className="about4-card opacity-0 p-6 rounded-2xl bg-white border border-gray-100 shadow-sm hover:shadow-lg hover:border-[#8EC5FF] transition-all duration-300 group">
                ...
                <div className="about4-card opacity-0 p-6 rounded-2xl bg-white border border-gray-100 shadow-sm hover:shadow-lg hover:border-[#F99321] transition-all duration-300 group">
                ...
                <div className="about4-text opacity-0 relative group">
