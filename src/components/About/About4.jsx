...
export default function About4() {
  ...
  useLayoutEffect(() => {
    let ctx = gsap.context(() => {
      // 1. Heading Reveal (Using .from for safety)
      gsap.from(".about4-header", {
        y: 50,
        autoAlpha: 0, // opacity + visibility handle karega
        duration: 1,
        ease: "power3.out",
        scrollTrigger: {
          trigger: ".about4-header",
          start: "top 90%", // Thoda jaldi dikhna shuru hoga
        },
      });

      // 2. Icon Cards Stagger
      gsap.from(".about4-card", {
        y: 50,
        autoAlpha: 0,
        duration: 0.8,
        stagger: 0.2,
    ...
    // Force Refresh after a delay to handle About1 image shift
  ...
  return (
    <section ref={containerRef} className="relative py-24 px-6 md:px-20">
        ...
        <div className="max-w-7xl mx-auto">
            ...
            {/* Left Column (Header) - Class 'about4-header' added */}
            <div className="lg:col-span-5 lg:sticky lg:top-32 about4-header invisible"> 
            ...
            <div className="lg:col-span-7 space-y-12 right-column">
                ...
                <div className="about4-text invisible">
                ...
                {/* Card 1 - Class 'about4-card' added */}
                <div className="about4-card invisible p-6 rounded-2xl bg-white border border-gray-100 shadow-sm hover:shadow-lg hover:border-[#8EC5FF] transition-all duration-300 group">
                ...
                {/* Card 2 - Class 'about4-card' added */}
                <div className="about4-card invisible p-6 rounded-2xl bg-white border border-gray-100 shadow-sm hover:shadow-lg hover:border-[#F99321] transition-all duration-300 group">
                ...
                <div className="about4-text invisible relative group">
