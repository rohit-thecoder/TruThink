  ...
  return (
    ...
    <div className="relative w-full max-w-8xl mx-auto md:py-20 md:px-20 md:pt-40">
      ...
      <div className="relative w-full h-[500px] overflow-hidden md:rounded-2xl">
        {/* Background Image */}
        <Image
          src="https://images.pexels.com/photos/3184424/pexels-photo-3184424.jpeg" // 🔁 Aap yahan apni image daal sakte hain
          alt="Background"
          layout="fill"
          objectFit="cover"
        ...
        <div
          className="absolute bottom-0 right-0 w-[340px] h-[130px] md:bg-white rounded-tl-[20px] 
